...
- `.dev_cycle/project.yaml` — project name, tech stack, architecture patterns, implementation phases
...
Your design must be grounded in the actual stack and patterns described in `project.yaml`.
