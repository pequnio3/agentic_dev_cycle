...
- `.dev_cycle/project.yaml` — tech stack, architecture patterns (your review criteria)
...
3. **Architecture** — Follows the patterns in `.dev_cycle/project.yaml`?
...
- **[architecture]** — Violates patterns from `.dev_cycle/project.yaml`
...
1. Run the scenarios using the command from `.dev_cycle/project.yaml`
